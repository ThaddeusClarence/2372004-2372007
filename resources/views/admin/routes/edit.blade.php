    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.routes.update', $route) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="origin_city" id="origin_city" value="{{ old('origin_city', $route->origin_city) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="destination_city" id="destination_city" value="{{ old('destination_city', $route->destination_city) }}"
                       class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
            </div>

            <div class="mb-4">
                <label for="distance_km" class="block text-sm font-medium text-gray-700 mb-1">Distance (km)</label>
                <input type="number" name="distance_km" id="distance_km" value="{{ old('distance_km', $route->distance_km) }}" min="1"
                       class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
            </div>

            <div class="mb-6">
                <label for="duration" class="block text-sm font-medium text-gray-700 mb-1">Duration (HH:MM)</label>
                <input type="time" name="duration" id="duration" value="{{ old('duration', $route->duration) }}"
                       class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
            </div>

            <div class="flex gap-3">
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">Update Route</button>
