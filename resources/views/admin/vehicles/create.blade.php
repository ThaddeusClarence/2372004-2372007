        ...
        <form action="{{ route('admin.vehicles.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="vehicle_type" id="vehicle_type" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="Shuttle" {{ old('vehicle_type') == 'Shuttle' ? 'selected' : '' }}>Shuttle</option>
                </select>
            </div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">Create Vehicle</button>
