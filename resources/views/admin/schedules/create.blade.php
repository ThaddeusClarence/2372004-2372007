        ...
        <form action="{{ route('admin.schedules.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="datetime-local" name="departure_time" id="departure_time" value="{{ old('departure_time') }}"
                ...
                <div>
                    ...
                    <input type="datetime-local" name="arrival_estimate" id="arrival_estimate" value="{{ old('arrival_estimate') }}"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                </div>
            </div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">Create Schedule</button>
